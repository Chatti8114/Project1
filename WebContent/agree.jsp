...
<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: rgba(230,230,230,.8)">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarID2">
        <ul class="navbar-nav ">
            ...
            <li class="nav-item">
                <a class="nav-link" href="MemberJoin.me"><i class="fa fa-users"></i> 회원가입</a>
            </li>
            <%} else { %>
...
<div class="container">
    ...
    <div class="mb-5 p-5" style="border: 5px solid #E67E22; border-radius: 10px;">
        <form id="agreeform" action="MemberJoin.me" method="post" class="was-validated mx-auto">
            <div class="form-group">

                <textarea rows="20px"  style="width:100%;border:1; overflow:visible;text-overflow:ellipsis; font-family: 돋움; font-size: 12pt; align-content: center;" readonly="readonly">가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
...
- 생성정보 수집 툴을 통한 수집
                ...
                <br> <br>
                <input  type="checkbox" name="req" align="center"> 개인정보 수집 및 이용에 동의합니다.
                </td>
                </tr>
                <br>
                <tr>
