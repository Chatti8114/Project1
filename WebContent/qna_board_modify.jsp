        ...
        <div class="col-sm-11 text-center" >
            ...
            <form action="BoardModifyAction.bo" method="post" enctype="multipart/form-data" name="modifyform">
                ...
                <table class="table table-boardered" >
                    <tr>
                        <th style="vertical-align: middle" style="width: 30%">카테고리</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="form-control" name="BOARD_TITLE" value="<%=board.getBOARD_TITLE() != null ? board.getBOARD_TITLE() : "" %>" required></td>
                    </tr>
                    <tr>
                            ...
                            <div class="input-group" style="width: 350px">
                                <select style="font-size: 13pt" id="area" name="BOARD_AREA1" class="form-control">
                                    <%
                                        String area = "";
                                        try {
                                            area = (board.getBOARD_AREA().split(" ")[0]) ;
                                        } catch (Exception e) {
                                            System.out.println("지역명이 널값입니다");
                                            area ="";
                                        }
                                    %>
                                    <option value="">- 시도 -</option>
                                    <option <%=area.equals("서울특별시") ? "selected" : ""%> value="서울특별시">서울특별시</option>
                                    <option <%=area.equals("부산광역시") ? "selected" : ""%> value="부산광역시">부산광역시</option>
                                    <option <%=area.equals("대구광역시") ? "selected" : ""%> value="대구광역시">대구광역시</option>
                                    <option <%=area.equals("인천광역시") ? "selected" : ""%> value="인천광역시">인천광역시</option>
                                    <option <%=area.equals("광주광역시") ? "selected" : ""%> value="광주광역시">광주광역시</option>
                                    <option <%=area.equals("대전광역시") ? "selected" : ""%> value="대전광역시">대전광역시</option>
                                    <option <%=area.equals("울산광역시") ? "selected" : ""%> value="울산광역시">울산광역시</option>
                                    <option <%=area.equals("세종특별자치시") ?  "selected" : ""%> value="세종특별자치시">세종특별자치시</option>
                                    <option <%=area.equals("경기도") ? "selected" : ""%> value="경기도">경기도</option>
                                    <option <%=area.equals("강원도") ? "selected" : ""%> value="강원도">강원도</option>
                                    <option <%=area.equals("충청북도") ?  "selected" : ""%> value="충청북도">충청북도</option>
                                    <option <%=area.equals("충청남도") ? "selected" : ""%> value="충청남도">충청남도</option>
                                    <option <%=area.equals("전라북도") ? "selected" : ""%> value="전라북도">전라북도</option>
                                    <option <%=area.equals("전라남도") ? "selected" : ""%> value="전라남도">전라남도</option>
                                    <option <%=area.equals("경상북도") ? "selected" : ""%> value="경상북도">경상북도</option>
                                    <option <%=area.equals("경상남도") ? "selected" : ""%> value="경상남도">경상남도</option>
                                    <option <%=area.equals("제주특별자치도") ? "selected" : ""%> value="제주특별자치도">제주특별자치도</option>
                                </select>
                                <select  style="font-size: 13pt" id="city" name="BOARD_AREA2" class="form-control">
                                    <%
                                        String area2="";
                                        try {
                                            area2 = board.getBOARD_AREA().split(" ")[1];
                                        } catch (Exception e) {
                                            area2 ="";
                                        }
                                    %>
                                    <option value="<%= area2 %>">- 시군구 -</option>
                                </select>
                            </div>
                        </td>
                        <%--                        <td><input type="text" class="form-control" name="BOARD_AREA" value="<%=board.getBOARD_AREA()%>"></td>--%>
                    ...
                    <tr>
                        ...
                        <%
                            String area3="";
                            try {
                                area3 = board.getBOARD_AREA().split(" ")[2];
                            } catch (Exception e) {
                                area3 ="";
                            }
                        %>
                        <td colspan="3"><input type="text" class="form-control" name="BOARD_AREA3" placeholder="상세주소" value="<%= area3 %>" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input style="width: 200px" min="0" value="<%=board.getBOARD_PRICE()%>" type="number" class="form-control" name="BOARD_PRICE" onclick="this.select()" required></td>
                    </tr>
                    <tr>
                            ...
                            <label for="radio_1" class="p-1 mb-0">
                                <div class="custom-control custom-control-inline custom-radio pr-3">
                                    <input type="radio" class="custom-control-input" id="radio_1" name="BOARD_REFUND"
                                           value="유" <%=board.getBOARD_REFUND().equals("유") ?  "checked" : ""%> required>
                            ...
                            <label for="radio_2" class="p-1 mb-0">
                                <div class="custom-control custom-control-inline custom-radio">
                                    <input type="radio" class="custom-control-input btn-lg" id="radio_2" name="BOARD_REFUND"
                                           value="무" <%=board.getBOARD_REFUND().equals("무") ?  "checked" : ""%> required>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="number" min="0" value="<%=board.getBOARD_DELIVERY()%>" class="form-control" name="BOARD_DELIVERY" style="width: 200px" onclick="this.select()" required></td>
                    </tr>

                    <tr>
                        <th><div>내 용</div></th>
                        <td colspan="3"><textarea name="BOARD_CONTENT" cols="105" rows="20" placeholder="내용을 입력하세요"><%= board.getBOARD_CONTENT() %></textarea></td>
                    </tr>
                    <%if((board.getBOARD_FILE1()==null)){%>
                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt">첨부파일1</div></th>
                        <td colspan="3"><input name="BOARD_FILE1" type="file"></td>
                    </tr>
                    <% } else {%>
                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt">첨부파일1</div></th>
                        <td colspan="3"><input class="sr-only" name="BOARD_FILE1" type="file"><img width="70" height="70" src="boardupload/<%= board.getBOARD_FILE1() %>" alt=""><div style="display: inline;">&nbsp;&nbsp;&nbsp;<%= board.getBOARD_FILE1() %></div><div class="fa fa-times text-danger"></div>
                            <input type="hidden" name="BOARD_FILE1_r" value="<%= board.getBOARD_FILE1() %>">
                        </td>
                    ...
                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt" >첨부파일2</div></th>
                        <td colspan="3"><input name="BOARD_FILE2" type="file"></td>
                    </tr>
                    <% } else {%>
                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt">첨부파일2</div></th>
                        <td colspan="3"><input class="sr-only" name="BOARD_FILE2" type="file"><img width="70" height="70" src="boardupload/<%= board.getBOARD_FILE2() %>" alt=""><div style="display: inline;">&nbsp;&nbsp;&nbsp;<%= board.getBOARD_FILE2() %></div><div class="fa fa-times text-danger"></div>
                            <input type="hidden" name="BOARD_FILE2_r" value="<%= board.getBOARD_FILE2() %>">
                        </td>
                    </tr>

                    <% }%>

                    <%if((board.getBOARD_FILE3()==null)){%>

                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt">첨부파일3</div></th>
                        <td colspan="3"><input name="BOARD_FILE3" type="file"></td>
                    </tr>

                    <% } else {%>
                    <tr>
                        <th style="vertical-align: middle"><div align="center" style="font-size: 10pt">첨부파일3</div></th>
                        <td colspan="3"><input class="sr-only" name="BOARD_FILE3" type="file"><img width="70" height="70" src="boardupload/<%= board.getBOARD_FILE3() %>" alt=""><div style="display: inline;">&nbsp;&nbsp;&nbsp;<%= board.getBOARD_FILE3() %></div> <div class="fa fa-times text-danger"></div>
                            <input type="hidden" name="BOARD_FILE3_r" value="<%= board.getBOARD_FILE3() %>">
                        </td>
                    </tr>
                    <% }%>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <a href="javascript:addboard()" class="btn btn-primary">수정</a>&nbsp;&nbsp;
...
<script>
    $(function () {
        ...
        $("#area").change(function () {
            s_index = ($("#area option").index($("#area option:selected")));
            childText ="";
            $("#city").children().remove().addBack().append(area[s_index]);
            $("#city option").each(function () {
                childText = $(this).text();
        ...
        $(".fa-times").each(function (i) {
            $(this).click(function () {
                $(this).prevUntil("input").remove();
                $(this).next().val("");
                // alert($(this).next().val());
                $(this).prev().removeClass("sr-only");
                $(this).remove();
            })
        });
        ...
        function readURL(input) {
            if (input.files && input.files[0]) { /* 인풋박스 파일인지, 파일의 프로퍼티가 있는지 검사 */
                ...
                reader.onload = function(e) { /* 파일이 로드되면 실행한다? */
                    ...
                    var item = $(":file").eq(i-1);
                    item.addClass("sr-only");
                    item.after(" " + i + " 번째 이미지 <div class='fa fa-times text-danger'></div>");
                    $("<img src='"+e.target.result+"' width='70' height='70'>").insertAfter(item);

                    // $(":file").eq(i-1).after("<img src='"+e.target.result+"' width='200px' height='150px' style='display: block;'>");
